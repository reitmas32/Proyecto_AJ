 ...
 *@param this Aputnador de tipo DLL
 *
 *@param other Apuntdor de tipo DLL
 *
 *@param pfun Función que puede hacer cualquier cosa que necesite el valor de un nodo de la primera DLL y de la segunda DLL, recibe el apuntador a ambos nodos y retorna un valor de tipo booleano
 *
 *@return Un valor de tipo booleano indicando si la accion es posible;
 */
